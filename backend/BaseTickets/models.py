...
class Usuario(models.Model):
    ...
    telefono = models.PositiveIntegerField(verbose_name="Teléfono Usuario", null=True, blank=True)
...
class Tique(models.Model):
    ...
    fecha = models.DateField(auto_now_add=True,verbose_name="Fecha Tique")
    ...
    area = models.ForeignKey(Group, verbose_name="Área",on_delete=models.CASCADE)
