<template>
                        ...
                        <v-card-text fluid class="d-flex justify-center align-center fill-height">
                          <v-container>
                            <v-row>
                              ...
                              <v-col cols="12" md="6">
                                <v-card title="Cerrado Por:" :text="editedItem.name_cierre || 'no existe de momento'" style="border: 1px solid #017bab;"></v-card>
                              </v-col>
                              <v-col cols="12" md="6">
                                <v-card title="Fecha de creacion:" :text="editedItem.fecha_creacion || 'no existe fecha de momento'" style="border: 1px solid #017bab;"></v-card>
                              </v-col>
                              <v-col cols="12" md="6">
                                <v-card title="Fecha de cierre:" :text="editedItem.fecha_cierre || 'no existe fecha de momento'" style="border: 1px solid #017bab;"></v-card>
                              </v-col>
                            </v-row>
                          </v-container>
                        </v-card-text>
                    ...
                    <v-dialog v-model="dialogDelete" max-width="565px">
                      <v-card>
                        <v-card-title class="text-h5">
                          ¿Estás seguro de que quieres eliminar el Tique?
                        </v-card-title>
                        <v-card-actions>
                          <v-spacer></v-spacer>
  ...
  export default {
    ...
    data: () => ({
      ...
      problemaRules: [
        value => {
          ...
          if (!value) return 'El titulo del problema es requerido.'; // Verificar si está vacío
      ...
      areaRules: [
        value =>  {
          ...
          if  (!value) return 'debe seleccionar valores.';
    ...
    computed: {
      formTitle() {
        return this.editedIndex === -1 ? 'Nuevo Tique' : 'Editar Tique';
      },
    },
